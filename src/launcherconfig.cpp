...
{
    this->config_file = Glib::KeyFile::create();
    try
    {
        this->config_file->load_from_file( CONFIG_FILE_NAME , Glib::KeyFile::Flags::KEEP_COMMENTS | Glib::KeyFile::Flags::KEEP_TRANSLATIONS );
    }
